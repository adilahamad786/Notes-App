...
// befor Short hand of Arrow function or ES6
// const fs = require('fs');
// const chalk = require('chalk');
...
//     const duplicateNotes = notes.filter( (note) => {  // save duplicate notes from notes list (means file)
//         return note.Title === title;      // checking same title present or not in notes list (means file)
//         // Note : inside notes list means file have Title as a key so we access vaule using note.Title
//     })
...
//     const notesToKeep = notes.filter((note) => {   // remove which note this title is match or put all unmatch notes in notesToKeep
